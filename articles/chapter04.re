...
一方で、insert, update, delete によりレコードを1件でも変更したら「ファイル全体を書き直している」という点が非効率です。1万件のレコードがある状態で1件を更新すると、変更のなかった9999件も含めてすべてを書き出すことになります。書き込む量はレコードの総数に比例して増えていくため、データが増えるほど1回の更新が重くなっていきます。
